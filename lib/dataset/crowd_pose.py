...
class CrowdPoseDataset(JointsDataset):
	...
	"skeleton": [
        [12,13],[13,0],[13,1],[0,1],[0,6],[1,7],[6,7], [0,2],[2,4],
        [1,3],[3,5],[6,8],[8,10],[7,9],[9,11]]
    '''
    def __init__(self, cfg, root, image_set, is_train, transform=None):
        ...
        # Always use gt bbox for CrowdPose.
        self.bbox_file = ''
    ...
    def _get_ann_file_keypoint(self):
        """ self.root / json / crowdpose_trainval.json """
        prefix = 'crowdpose'
        return os.path.join(
            self.root,
            'json',
    ...
    def image_path_from_index(self, index):
        """ example: images / 100005.jpg """
        file_name = '%d.jpg' % index

        image_path = os.path.join(
            self.root,
            'images.zip@' if self.data_format == 'zip' else 'images',
            file_name)
    ...
    def evaluate(self, cfg, preds, output_dir, all_boxes, img_path,
        ...
        # CrowdPose has test set annotation.
